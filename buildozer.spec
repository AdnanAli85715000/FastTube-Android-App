...
requirements = python3,kivy==2.1.0,requests,certifi,pyjnius,ffmpeg,yt-dlp,Pillow

# (str) Kivy version
kivy.version = 2.1.0

# (list) Python modules folder (project root ko include karein)
source.include_dirs =
...
android.ndk = 25b
android.ndk_api = 21
# Android NDK path (Buildozer khud manage karega, lekin yahan specify karna theek hai)
android.ndk_path = /home/runner/.buildozer/android/platform/android-ndk-r25b

# (str) Python-for-Android version
# "master" latest stable version uthayega. Agar stability issue aaye to specific version (e.g., 0.6.0) use karein.
p4a.version = master

# (str) Build tools version (AIDL error ko fix karta hai)
# Yeh version Android SDK ke build tools se match hona chahiye jo install honge.
...
# Yeh section AndroidManifest.xml mein intent-filters add karega
android.activities = \
...
# (str) The directory containing the app's source code (redundant but for troubleshooting)
source_dir = . # <<< Yeh line [app] section mein bhi hai
